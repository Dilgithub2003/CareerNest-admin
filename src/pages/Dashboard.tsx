...
const Dashboard = () => {
  return <div className="ml-64">
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        <StatCard title="Total Users" value="1,432" change="+12% from last month" icon={<Users className="w-5 h-5 text-white" />} iconColor="bg-blue-500" />
        <StatCard title="Active Job Posts" value="210" change="+5% from last week" icon={<Briefcase className="w-5 h-5 text-white" />} iconColor="bg-purple-500" />
        <StatCard title="Applications" value="85" change="-3% from yesterday" icon={<FileCheck className="w-5 h-5 text-white" />} iconColor="bg-green-500" />
        <StatCard title="Interviews Scheduled" value="115" change="+8% from last week" icon={<Calendar className="w-5 h-5 text-white" />} iconColor="bg-orange-500" />
      </div>
